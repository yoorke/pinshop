                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <asp:RadioButtonList ID="rdbDelivery" runat="server" RepeatColumns="1" RepeatDirection="Vertical" RepeatLayout="Flow" CssClass="radio" OnSelectedIndexChanged="rdbDelivery_SelectedIndexChanged" AutoPostBack="true">
                                                <asp:ListItem Text="Dostava kurirskom službom" Value="2" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Preuzimanje u radnji" Value="1"></asp:ListItem>                                                
                                            </asp:RadioButtonList>
                            ...
                            <div class="row cartView">
                                <div class="col-lg-12">
                                    ...
                                    <p>
                                        ...
                                        <asp:Label ID="lblDiscount" runat="server" CssClass="price"></asp:Label>
                                    </p>
                                    <p>
                                        <span class="priceTitle">Kupon:</span>
                                        <asp:Label ID="lblCoupon" runat="server" CssClass="price"></asp:Label>
